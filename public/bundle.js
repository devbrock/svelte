...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-9noqbk");
    			add_location(h1, file, 21, 0, 237);
    			add_location(button0, file, 22, 0, 286);
    			add_location(button1, file, 23, 0, 331);

    			dispose = [
    				listen_dev(button0, "click", ctx.upAge),
    				listen_dev(button1, "click", ctx.changeName)
    			];
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      function changeName() {
    	...
    	return { age, upAge, changeName, uppercaseName };
    }
